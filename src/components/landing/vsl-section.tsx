    ...
    <section id="vsl" className="pt-16 pb-12 sm:pt-24 sm:pb-16 bg-background">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight">
          Método Secreto que quem <span className="text-primary">Passa no ENEM</span> <span className="text-red-500">Não Quer</span> que Você <span className="text-red-500">Descubra</span>
        </h1>
