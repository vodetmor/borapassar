          ...
          <CardContent className="p-6 sm:p-8 pt-0">
             <div className="bg-background/50 border border-border/50 rounded-lg p-4 mb-6">
                ...
                <div className="flex items-center gap-2 mt-2">
                    <p className="font-mono text-2xl sm:text-3xl font-bold my-2 text-yellow-400 tracking-widest bg-black/50 py-2 rounded-md flex-grow">FLASH100</p>
                    <Button variant="outline" size="icon" onClick={() => handleCopy('FLASH100')}>
