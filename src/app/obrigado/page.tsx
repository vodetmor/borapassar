      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl bg-zinc-900/50 border-primary/20 shadow-2xl shadow-primary/10 text-center animate-in fade-in-50 zoom-in-95 duration-500">
          ...
          <CardContent className="p-6 sm:p-8 pt-0">
            ...
            <Button asChild size="lg" className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-accent/90 text-lg font-bold shadow-xl shadow-accent/20 px-8 py-7">
              <Link href="/login">
